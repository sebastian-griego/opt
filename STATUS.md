...
# Best known (local)
Best value: 0.389962823816 (m=50, fft eval)
Found by: hillclimb_kswap (steps=300000, seed=18, kswap-k=7)
Reproduce: python experiments/c1b/search.py --m 50 --seed 18 --steps 300000 --operator kswap --kswap-k 7 --snapshot-every 0
...
- Change: Increased kswap-k=7 steps to 300000 for seed=18 at m=50 and logged the run.
- Result: Best improved to 0.389962823816; results.csv appended and best_candidate.json updated.
- Next: Try 400000 steps for seed=18 with k=7 or try another seed with k=7.
