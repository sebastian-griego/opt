...
# Best known (local)
Best value: 0.401788532297 (m=50, fft eval)
Found by: hillclimb_kswap (steps=20000, seed=6)
Reproduce: python experiments/c1b/search.py --m 50 --seed 6 --steps 20000 --operator kswap --snapshot-every 0
...
- Change: Increased kswap steps to 20000 for seed=6 at m=50 and logged the run.
- Result: Best improved to 0.401788532297; results.csv appended and best_candidate.json updated.
- Next: Try 30000 steps for seed=6 or run a new seed with 20000 steps.
