...
# Best known (local)
Best value: 0.393682545927 (m=50, fft eval)
Found by: hillclimb_kswap (steps=120000, seed=14, kswap-k=7)
Reproduce: python experiments/c1b/search.py --m 50 --seed 14 --steps 120000 --operator kswap --kswap-k 7 --snapshot-every 0
...
- Change: Increased kswap-k=7 steps to 120000 for seed=14 at m=50 and logged the run.
- Result: Best improved to 0.393682545927; results.csv appended and best_candidate.json updated.
- Next: Try 160000 steps for k=7 or explore k=6 with higher steps.
