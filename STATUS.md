...
# Best known (local)
Best value: 0.388826649448 (m=50, fft eval)
Found by: hillclimb_kswap (steps=500000, seed=20, kswap-k=7)
Reproduce: python experiments/c1b/search.py --m 50 --seed 20 --steps 500000 --operator kswap --kswap-k 7 --snapshot-every 0
...
- Change: Ran a new seed=20 with kswap-k=7 at m=50 for 500000 steps and logged the run.
- Result: Best improved to 0.388826649448; results.csv appended and best_candidate.json updated.
- Next: Increase steps for seed=20 with k=7 or try another seed with k=7.
