...
# Best known (local)
Best value: 0.388253619204 (m=50, fft eval)
Found by: hillclimb_kswap (steps=1500000, seed=20, kswap-k=7)
Reproduce: python experiments/c1b/search.py --m 50 --seed 20 --steps 1500000 --operator kswap --kswap-k 7 --snapshot-every 0
...
- Change: Ran kswap-k=7 for seed=20 at 1,500,000 steps plus a short 20,000-step seed=21 run, and logged both.
- Result: Best improved to 0.388253619204; results.csv appended and best_candidate.json updated.
- Next: Try 1,800,000 steps for seed=20 with k=7 or try another seed with k=7.
