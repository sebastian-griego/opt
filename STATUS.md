...
- Change: Ran `python experiments/c1b/search.py --m 50 --seed 389000000000 --steps 20000 --operator kswap --kswap-k 7 --snapshot-every 0` and logged it.
- Result: Best unchanged at 0.387791883826 (fft eval); results.csv appended.
- Next: Try another seed with k=7 (e.g., seed=390000000000).
