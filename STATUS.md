...
# Best known (local)
Best value: 0.388266163681 (m=50, fft eval)
Found by: hillclimb_kswap (steps=1200000, seed=20, kswap-k=7)
Reproduce: python experiments/c1b/search.py --m 50 --seed 20 --steps 1200000 --operator kswap --kswap-k 7 --snapshot-every 0
...
- Change: Increased kswap-k=7 steps to 1,200,000 for seed=20 at m=50 and logged the run.
- Result: Best improved to 0.388266163681; results.csv appended and best_candidate.json updated.
- Next: Try 1,500,000 steps for seed=20 with k=7 or try another seed with k=7.
